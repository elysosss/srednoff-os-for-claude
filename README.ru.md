...
<td>🟢 326 курируемых скиллов автоустанавливаются по тегам проекта, с капом по бюджету контекста</td>
</tr>
<tr>
...
<tr><td><code>skills-library/</code></td><td><strong>326 устанавливаемых скиллов</strong> — автовыбор по проекту, с капом по бюджету контекста</td></tr>
...
| `skills-library` + `docs` | CI + `doctor` | Все 326 устанавливаемых скиллов и доки корректно оформлены |
