...
текстовый каталог (грепай, читай, применяй вручную). Отдельная кураторская подгруппа (326 записей:
303 адаптированы из `SREDNOFF`, 7 более поздних импортов и 16 собственных Python/infra-скиллов,
