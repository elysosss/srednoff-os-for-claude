...
<td>🟢 326 curated skills auto-installed by project tags, capped for context budget</td>
</tr>
<tr>
...
<tr><td><code>skills-library/</code></td><td><strong>326 installable skills</strong> — auto-selected per project, capped for context budget</td></tr>
...
This drops the rulebook into your project, generates a `.claude/PROFILE.lock.md` tailored to what it detects (Next.js? Python? trading/backtest code? Amazon FBA?), auto-installs a capped, tag-matched shortlist from the 326-skill library, and never overwrites a `CLAUDE.md` you already have — it backs up and merges instead.
...
| `skills-library` + `docs` | CI + `doctor` | All 326 installable skills and docs are well-formed |
